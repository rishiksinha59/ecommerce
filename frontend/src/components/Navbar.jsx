...
const Navbar = () => {
  ...
  return (
    <div className="flex items-center justify-between py-5 font-medium">
      <Link to="/">
        <img src={assets.logo} className="w-[150px] md:w-[200px]" alt="" />
      </Link>
      ...
      <div className="flex items-center gap-6">
        {location.pathname==='/collection' &&  <img onClick={() => setShowSearch(!showSearch)} src={assets.search_icon} className="w-5 cursor-pointer" alt="" />}
        ...
        <Link to="/cart" className="relative">
          ...
          <p className="absolute right-[-5px] bottom-[-5px] w-4 text-[10px] text-center leading-4 bg-[green] text-white aspect-square rounded-full">{getCartCount()}</p>
        </Link>
